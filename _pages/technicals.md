...
I'm currently doing research at the Stanford AI Lab, advised by Prof. James Zou. One recent project I worked on is the effect of competing multi-agent feedback on learning can be found [here](https://arxiv.org/abs/2009.06797) and [here in blog post](https://hai.stanford.edu/blog/when-algorithms-compete-who-wins) format (CoopAI Workshop @ NeurIPS 20', to appear in AISTATS 21').
